...
CUSTOM_APPCAST_DOWNLOAD_URL_PREFIX="${APPCAST_DOWNLOAD_URL_PREFIX:-}"
...
APPCAST_DOWNLOAD_URL_PREFIX="${CUSTOM_APPCAST_DOWNLOAD_URL_PREFIX:-https://github.com/$REPO/releases/download/$TAG}"
